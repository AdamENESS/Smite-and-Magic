...
;		fswindow=CreateGLWindow("",winwid,winhgt,16,60,9)
;	EndIf
	; for more info about the next 4 lines look at the "How This Works" section in the Documentation
	Graphics3D winwid,winhgt,0,2
;	AppTitle gltitle$
;	DebugLog bglGetBlitzWindow(32,gltitle$) ; this grabs the Blitz, and sets it up to the required standard, 
