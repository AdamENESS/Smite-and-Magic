...
Function BuildFont()								; Build Our Bitmap Font
	...
	For loop=0 To 255						; Loop Through All 256 Lists
		...
		glNewList(base+loop,GL_COMPILE);				; Start Building A List
			...
			glTranslatef(15,0,0);						; Move To The Right Of The Character
